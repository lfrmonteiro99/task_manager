...
-- Note: Triggers commented out as they require DELIMITER which doesn't work in docker-entrypoint
-- You can create these manually after the database is initialized if needed
...
-- Note: Stored procedures commented out as they require DELIMITER which doesn't work in docker-entrypoint
-- You can create these manually after the database is initialized if needed
